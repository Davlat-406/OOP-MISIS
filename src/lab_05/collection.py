...
class ServerCollection:
    ...
    def sort_by(self, key_func, reverse=False):
        """
        Сортировка коллекции с использованием переданной функции-ключа.
    ...
    def filter_by(self, predicate):
        ...
        """
        Фильтрация коллекции с использованием переданной функции-предиката.
    ...
    def apply(self, func):
        ...
        func - функция, которая принимает элемент и возвращает что-то.
