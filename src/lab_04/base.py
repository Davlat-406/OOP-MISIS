...
class Server(Printable, Comparable, Connectable):
    ...
    # реалиация интерфейса comparable 
    def compare_to(self, other) -> int:
        """Сравнить серверы по имени"""
        if not isinstance(other, Server):
            return 1
    ...
    # реалиация интерфейса connectable
    ...
    def is_connected(self) -> bool:
        """Проверить, есть ли активные подключения"""
